# eaba89ee-3666-445f-8fcb-a093ebe95fc7 implementation handoff
...
## Entry points
- `compass-plus-gallery.html`
- `index.html`
- `screens/01-connect.html`
- `screens/02-connect-error.html`
- `screens/03-explorer.html`
- `screens/04-document-editor.html`
- `screens/05-aggregation.html`
- `screens/06-schema.html`
- `screens/07-investigate.html`
- `screens/08-metrics.html`
- `screens/09-dump-restore.html`
- `screens/10-shell.html`
- `screens/11-query-log.html`
- `screens/12-sidebar.html`
